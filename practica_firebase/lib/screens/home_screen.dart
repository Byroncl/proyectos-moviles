              ...
              Container(
                decoration: const BoxDecoration(
                  gradient: LinearGradient(
                    colors: [Color.fromARGB(255, 114, 114, 114), Color.fromARGB(255, 0, 0, 0)],
                            ...
                            children: [
                              ...
                              ElevatedButton.icon(
                                ...
                                style: ElevatedButton.styleFrom(
                                  backgroundColor: const Color.fromARGB(255, 8, 92, 1),
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color: const Color.fromARGB(255, 48, 0, 37).withOpacity(0.2),
                shape: BoxShape.circle,
              ),
              child: Icon(icon, size: 32, color: const Color.fromARGB(255, 88, 0, 122)),
            ),
